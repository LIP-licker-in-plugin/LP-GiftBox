package com.licker2689.lgb.commands;
...
public class LGBCommand implements CommandExecutor, TabCompleter {
...
.openPrizeSetting(p, args[1]);
        ...
        if (args[0].equals("cmd")) {
            ...
            LGBFunction
.setCustomModelData(p, args[1], args[2]);
            return false;
        }
        if (args[0].equals("쿠폰")) {
            if (args.length == 1) {
